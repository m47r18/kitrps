...
const P2 = {
  comprendre:{titre:"Comprendre et s'informer",ico:"livre",
    ...
    pts:["Se questionner sur sa capacité à comprendre, prévenir et accompagner les RPS pour les agents managés en direct ou en transverse",
         ...
         "Écouter les agents (individuellement et collectivement) pour comprendre la situation (savoir détecter les signaux faibles)",
  ...
  prevenir:{titre:"Comment agir pour prévenir les RPS",ico:"boussole",
    ...
    pts:["Identifier son propre état vis-à-vis de la situation",
         "Connaître les attitudes à éviter (vouloir solutionner, être dans la sympathie…)",
         "Détecter les situations professionnelles et personnelles à risque",
         "Savoir évaluer la cause et le degré de risque (évaluation RPS) et prendre des décisions",
         ...
         "S'appuyer sur des relais humains (préventeur, RH, ligne managériale, manager hiérarchique des agents, pairs…)",
         ...
         "Mettre en place des plans d'action pour aider les salariés à faire face aux RPS (gestion du stress, des changements, bonnes pratiques…) et les indiquer dans le Document unique d'évaluation des risques professionnels (DUERP)"]},
